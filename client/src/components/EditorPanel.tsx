      ...
      <div className="space-y-4 text-black">
        <div className="">
          ...
          <textarea
            ...
            className="w-full text-sm border border-gray-400 rounded-md p-2 focus:ring-2 focus:ring-indigo-500 outline-none min-h-20"
          ></textarea>
        </div>
        <div className="">
          <label className="block text-xs font-medium text-gray-500 mb-1">
          ...
          <input
            ...
            className="w-full text-sm border border-gray-400 rounded-md p-2 focus:ring-2 focus:ring-indigo-500 outline-none"
          ></input>
        </div>
